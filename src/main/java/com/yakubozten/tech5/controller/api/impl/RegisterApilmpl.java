...
import com.yakubozten.tech5.controller.api.IRegisterApi;
...
@CrossOrigin
public class RegisterApilmpl implements IRegisterApi<RegisterDto> {
    // Injection
    ...
    // LOGIN
    // FIND SURNAME
    // http://localhost:4444/register/api/v1.0.0/search?surname=ozten
    @Override
    @GetMapping("/search")
